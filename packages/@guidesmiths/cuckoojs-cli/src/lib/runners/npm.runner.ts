...
export class NpmRunner extends GenericRunner {
  private static ensurePackageSection(
  ...
  public async addPackages(name: string, packageEntries: PackageEntry[]) {
    ...
    for (const packageEntry of packageEntries) {
      ...
      packageJson[packageEntry.section][packageEntry.name] =
        packageEntry.version;
      packageJson[packageEntry.section] = sortObjectKeys(
        packageJson[packageEntry.section],
